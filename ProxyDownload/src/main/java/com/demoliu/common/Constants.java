...
public class Constants {
    ...
    private final static String PROJECT_LAST_DIR = System.getProperty("user.dir");

    //代理配置文件
    public static String PROXY_HOST_PRO = PROJECT_LAST_DIR + "/runtime/proxy.properties";

    //全局配置文件
    public static String CONFIG_PRO =  PROJECT_LAST_DIR + "/runtime/config.properties";
